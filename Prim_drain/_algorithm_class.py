...
class Primary_Drainage(Algorithm):
    ...
    def postprocessing(self, p_vals=None, points = None, p_max=None, p_min = None):
        ...
        the elements. True if it is there. Each column of the "corner" array
        is related to the columns of the half_corner_angle prop
        ...
        #Calcuating corner presence in pores and throats
        ...
        for i in p_vals:
            ...
            invaded_pores[center_clusters.pore_clusters == 0] = False #Helps to set inlet pores with non invaded throats as False
