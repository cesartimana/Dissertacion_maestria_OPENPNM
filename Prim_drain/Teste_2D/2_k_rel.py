...
np.save(f'results_K_Pc_PDR_{theta_r_sexag}', output) #If wp, then 0. Otherwise 1
np.savetxt(f'results_K_Pc_PDR_{theta_r_sexag}.txt', output, fmt=' %.5e '+' %.5e '+' %.5e ' + ' %.5e ', header=' sat // krel_w// krel_o // pc')
