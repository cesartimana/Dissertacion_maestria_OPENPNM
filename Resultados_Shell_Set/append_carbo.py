...
plt.legend(['Carb data old' , 'Carb data new', '$G_{max}$ for triangle', '$G_{max}$ for rectangle', '$G_{max}$ for ellipse'], fontsize="14")
plt.savefig(fname = 'Carb_G_'+net_type+'.pdf', format = 'pdf', pad_inches=0)
#-------------------------------------
