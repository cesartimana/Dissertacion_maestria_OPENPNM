...
NOTA: SI HAY CLUSTER ATRAPADO POR THROAT MTMM, NO SE REVISA. ESO ES INCORRECTO.
...
while s_inv < 65:
    ...
    with open('imbibition_process_altering_BC.pkl', 'wb') as fp:
