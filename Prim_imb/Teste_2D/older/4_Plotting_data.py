...
#results = np.load('results_K_Pc_altering_BC.npy')
results = np.load('results_K_Pc_layer_altering_BC.npy')
#st_0 = np.array(  [2.56375e-01 , 2.45123e-04 , 9.64648e-01 , 1.80000e+04 ] )
