...
theta_a = np.pi / 180 * 60 #Advancing contact contact_angle
...
with open('imbibition_process_altering_BC.pkl', 'rb') as fp:
...
np.save('results_K_Pc_altering_BC', output) #If wp, then 0. Otherwise 1
np.savetxt('results_K_Pc_altering_BC.txt', output, fmt=' %.5e '+' %.5e '+' %.5e ' + ' %.5e ', header=' sat // krel_w// krel_o // pc')
