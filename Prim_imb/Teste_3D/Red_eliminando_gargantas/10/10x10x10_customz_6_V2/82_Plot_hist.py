...
ws = op.Workspace()
proj = ws.load_project(filename=sampleName + '.pnm')
...
Dp, y_Dp = cum_hist(pn['pore.equivalent_diameter'])
...
beta_rep = pn['throat.half_corner_angle'][:,1]
...
At, y_At = cum_hist(pn['throat.cross_sectional_area'])
